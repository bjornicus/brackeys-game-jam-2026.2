...
pub(crate) struct CombatConfig {
    ...
    pub(crate) enemy_melee_damage: f32,
    pub(crate) enemy_melee_windup: f32,
    pub(crate) enemy_melee_cooldown: f32,
    pub(crate) enemy_health_drop_chance: f32,
    pub(crate) health_drop_healing: f32,
    ...
    pub(crate) player_death_presentation_duration: f32,
    pub(crate) terminal_trigger_size: bevy::prelude::Vec2,
    pub(crate) pickup_trigger_size: bevy::prelude::Vec2,
    pub(crate) reinforced_armor_maximum_health_increase: f32,
    pub(crate) reinforced_armor_healing: f32,
...
impl Default for CombatConfig {
    fn default() -> Self {
        Self {
            ...
            enemy_melee_damage: 20.0,
            enemy_melee_windup: 0.35,
            enemy_melee_cooldown: 1.0,
            enemy_health_drop_chance: 0.25,
            health_drop_healing: 25.0,
            player_maximum_health: 100.0,
            player_combat_hitbox_size: bevy::prelude::Vec2::new(48.0, 72.0),
            player_invulnerability_duration: 0.5,
            player_death_presentation_duration: 0.75,
            terminal_trigger_size: bevy::prelude::Vec2::splat(56.0),
            pickup_trigger_size: bevy::prelude::Vec2::splat(56.0),
            reinforced_armor_maximum_health_increase: 50.0,
            reinforced_armor_healing: 50.0,
